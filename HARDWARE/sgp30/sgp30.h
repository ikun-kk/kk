...
#define  SGP30_SCL_LOW    GPIO_ResetBits ( GPIOF, GPIO_Pin_1 )
#define  SGP30_SCL_HIGH    GPIO_SetBits ( GPIOF, GPIO_Pin_1 )

#define  SGP30_SDA_LOW    GPIO_ResetBits ( GPIOF, GPIO_Pin_0 )
#define  SGP30_SDA_HIGH    GPIO_SetBits ( GPIOF, GPIO_Pin_0 )
//#define  SGP30_SDA   PBout(1)

// USART GPIO 引脚宏定义
#define  SGP30_SCL_GPIO_CLK        RCC_APB2Periph_GPIOF
#define  SGP30_SCL_GPIO_PORT       GPIOF
#define  SGP30_SCL_GPIO_PIN        GPIO_Pin_1

#define  SGP30_SDA_GPIO_SDA        RCC_APB2Periph_GPIOF
#define  SGP30_SDA_GPIO_PORT       GPIOF
#define  SGP30_SDA_GPIO_PIN        GPIO_Pin_0
