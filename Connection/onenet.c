...
#define PROID		"username"

#define AUTH_INFO	"password"

#define DEVID		"username"
...
void OneNet_RevPro(unsigned char *cmd)
{
	...
	char numBuf[10];
	int num = 0;
	cJSON *json , *json_value,*json_value1;
	...
	switch(type)
	{
		...
		case MQTT_PKT_PUBLISH:														//接收的Publish消息
			...
			if(result == 0)
			{
				...
				{
					json_value = cJSON_GetObjectItem(json,"LED_SW");//找到名字为LED_SW的json 接收到LED_SW
					json_value1 = cJSON_GetObjectItem(json,"relay");
